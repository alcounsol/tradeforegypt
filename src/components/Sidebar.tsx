...
import {
  ...
  FileText, Calculator, Database, Menu, X, Home
} from 'lucide-react'
        ...
        <div className="lg:hidden fixed inset-0 z-[9995]">
          ...
          <div className="absolute top-0 right-0 bottom-0 w-[280px] bg-white shadow-2xl overflow-y-auto animate-slide-in-right">
            ...
            <div className="border-t border-gray-100 px-3 py-3 mt-2">
              <Link href="/settings" className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold text-gray-500 transition-all hover:bg-gray-50 hover:text-gray-700">
