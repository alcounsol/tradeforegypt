      ...
      <div className="page-content">
        <header className="top-header">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-base font-extrabold text-slate-900">الموردين</h1>
          </div>
        ...
        <main className="main-content">
          <div className="mb-6">
            ...
            <p className="page-subtitle">إدارة بيانات الموردين</p>
          </div>
              ...
              <div key={sup.id} className="bg-white rounded-lg shadow p-4">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => openEdit(sup)} className="icon-btn edit"><Edit className="h-4 w-4" /></button>
                    <button onClick={() => handleDelete(sup.id)} className="icon-btn delete"><Trash2 className="h-4 w-4" /></button>
                  </div>
                </div>
                {sup.contact_person && (
        ...
        {showForm && (
          <div className="modal-overlay">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h2 className="text-lg font-extrabold mb-5">{editItem ? 'تعديل مورد' : 'إضافة مورد جديد'}</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="form-label">اسم الشركة/المورد *</label>
